...
보석을 품은 조각의 체력이 0이 되면 보석이 내부 위치에서 방금 깬 구멍을 통해 튀어나와 본래 크기로 펼쳐집니다. 이때 넓은 절단면이 카메라를 향하도록 돌아 보석의 외형과 내부 반사가 보입니다. 짧은 등장 동작이 끝난 뒤 보석을 직접 때리면 회수합니다. 한 보석이 나와도 다른 돌조각과 그 안의 보석은 그대로 유지됩니다.
