...
const CATALOG: Array[Dictionary] = [
	...
	{"id":"beer","kind":"aux","title":"맥주","price":Balance.AUX_PRICES[1],"headline":"최대 스태미나 +%d" % (BEER_HEALTH * Stamina.UNITS_PER_POINT),"subtitle":"구매 후 계속 적용","description":"채굴을 조금 더 오래 이어갑니다.\n스킬의 최대 스태미나 증가와 함께 적용됩니다.","color":Color("edbb60")},
