...
const CATALOG: Array[Dictionary] = [
	...
	{"id":"crusher","kind":"aux","title":"분쇄기","price":Balance.AUX_PRICES[3],"headline":"남은 보석 가치 50% 회수","subtitle":"R · 컨트롤러 X · 화면 버튼","description":"현재 원석을 갈고 다음 원석으로 넘어갑니다.\n재사용 대기시간 30초.\n이미 모은 보석의 가치는 유지됩니다.\n갈아버린 일반 돌은 정산하지 않습니다.","color":Color("e7a866")},
	...
	{"id":"detonator","kind":"aux","title":"기폭장치","price":Balance.AUX_PRICES[6],"headline":"현재 원석 전체 폭파","subtitle":"Space · 컨트롤러 L3 · 화면 버튼","description":"모든 돌 조각을 즉시 제거하고 보석을 회수합니다.\n채굴 라운드마다 한 번 사용할 수 있습니다.","color":Color("eb9472")},
]
