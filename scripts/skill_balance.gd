extends RefCounted
## Campaign v2 effects. Prices share the campaign economy table.
const Balance = preload("res://scripts/game_balance.gd")
const VALUES := {
	"base_power": 1.0, "power": 1.0, "speed": 0.16, "range": 0.25, "base_radius": 0.38,
	...
	"combo_step": 0.01, "combo_damage_cap": 2.0, "combo_duration": 6.0, "combo_time_step": 2.0,
	...
	"bomb_damage": 35.0, "bomb_attack_ratio": 0.35, "bomb_damage_step": 0.35, "gold_stone_amount": 90.0, "gold_stone_step": 0.5,
	"neighbor_radius": 1.6
}
