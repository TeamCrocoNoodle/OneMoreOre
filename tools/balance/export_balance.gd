...
func _initialize() -> void:
	...
	var output := {"version":"2026-09-13-v1","skill_effects":Effects.VALUES,"skill_depth_costs":B.SKILL_DEPTH_COSTS,"skill_premiums":B.SKILL_PREMIUMS,"total_skill_gold":total,"total_final_build_gold":total+auxiliary_cost+B.MAIN_PRICES[-1],"main_tools":M.CATALOG,"aux_tools":A.CATALOG,"gem_gold":B.GEM_GOLD,"ores":ores,"bosses":Boss.BOSSES,"full_build":aux.apply_to(main.apply_to(skills.stats())),"recovery_budget_fraction":B.RECOVERY_BUDGET,"crusher_cooldown":A.CRUSHER_COOLDOWN,"laser_interval":[A.LASER_MIN,A.LASER_MAX],"beer_health":A.BEER_HEALTH,"pin_chance":A.PIN_CHANCE,"pin_radius":A.PIN_RADIUS}
